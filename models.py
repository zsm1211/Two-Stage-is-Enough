...
class GAP_net(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.units = args.num_block
        self.nF = args.B
        self.size = args.size
        self.cnn3d_net1 = Re3dcnn_mask(self.units)
        self.cnn3d_net2 = Re3dcnn_mask(self.units)
        ######### Comment out the following for 2 stage###########
        self.cnn3d_net3 = Re3dcnn_mask(self.units)


    def forward(self,y, Phi, Phi_s, meas_re,args):
        x_list = []
        out = At(y, Phi)
